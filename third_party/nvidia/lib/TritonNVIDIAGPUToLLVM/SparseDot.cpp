...
// TODO(sparsity):
// Originally there was just a definition for this (and expected to link with WGMMA.cpp);
// but in WGMMA.cpp it's marked as static; how did that work?
...
Value smemDescriptor(int A, int B, ConversionPatternRewriter &rewriter,
  ...
  int elemsPerSwizzlingRow =
      kMmaLineSize / kMmaPerPhase / elemBytes;
